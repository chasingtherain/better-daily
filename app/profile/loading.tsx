...
export default function Loading() {
    ...
    return(    
        ...
        <div className="flex flex-col items-center gap-5 mt-10 md:mt-20">
            ...
            <Skeleton className={`animate-pulse h-5 w-[200px] md:w-[350px] dark:bg-slate-200 bg-slate-400 rounded-[4px]`}/>
            <Skeleton className={`animate-pulse h-5 w-[220px] md:w-[380px] dark:bg-slate-200 bg-slate-400 rounded-[4px]`}/>
